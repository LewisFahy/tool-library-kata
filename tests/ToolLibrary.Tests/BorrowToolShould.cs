...
///   - Execute takes a command, not domain entities
///   - no business rules inside Execute
///   - everything external lives behind an interface you own
/// </summary>
[TestFixture]
public class BorrowToolShould
{
    [Test]
